...
class MinimalPublisher(Node):
    ...
    def __init__(self):
        ...
        self.subscription = self.create_subscription(MAMstatus ,'status/yaxis',self.callback,10)
        self.subscription
        
        self.pub = self.create_publisher(Scanner, 'status/scanner_off', 10)

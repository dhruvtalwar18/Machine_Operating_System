...
class MinimalPublisher(Node):
    ...
    def __init__(self):
        super().__init__('reset_x_axis')
        self.subscription = self.create_subscription(MAMstatus ,'current_status/zaxis',self.callback,10)
        self.subscription
        self.pub = self.create_publisher(MAMstatus, 'current_status/xaxis', 10)
